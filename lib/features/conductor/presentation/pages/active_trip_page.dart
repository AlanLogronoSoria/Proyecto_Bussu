...
class _ActiveTripPageState extends ConsumerState<ActiveTripPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(children: [
        const GoogleMap(initialCameraPosition: CameraPosition(target: LatLng(-12.0464, -77.0428), zoom: 15)),
        Positioned(top: 56, left: 16, right: 16, child: Container(padding: const EdgeInsets.all(12), decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(12), boxShadow: const [BoxShadow(color: Color(0x14002F6C), blurRadius: 8)]), child: Row(children: [
          Container(padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4), decoration: BoxDecoration(color: trip != null ? const Color(0xFFFED000) : Colors.grey[300]!, borderRadius: BorderRadius.circular(8)), child: Text(trip != null ? 'En Ruta' : 'Detenido', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: trip != null ? const Color(0xFF001B44) : const Color(0xFF434750), fontFamily: 'Inter'))),
        ...
        Positioned(bottom: 0, left: 0, right: 0, child: Container(decoration: BoxDecoration(color: Colors.white, borderRadius: const BorderRadius.vertical(top: Radius.circular(20)), boxShadow: const [BoxShadow(color: Color(0x14002F6C), blurRadius: 16, offset: Offset(0, -4))]), padding: const EdgeInsets.all(24), child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          const Text('/ 40 capacidad', style: TextStyle(fontSize: 14, color: Color(0xFF434750), fontFamily: 'Inter')),
